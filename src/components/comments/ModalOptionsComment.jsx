  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          data-open
          className="absolute bg-gray-800 p-2 rounded-2xl flex flex-col gap-2"
        >
          <button
            onClick={() => handleClickEdit(comment)}
            className="text-white hover:bg-gray-600 rounded-xl text-md font-semibold p-1"
          >
            Editar
          </button>
          <button
            onClick={() => handleClickEdelete(comment?.id)}
            className="text-white hover:bg-gray-600 rounded-xl text-md font-semibold p-1"
          >
            Eliminar
          </button>
